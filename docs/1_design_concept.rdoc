...
* Functioning Design Library populated with Conceptual Model options (Business Goals, Requirements, Constraints & Assumptions), Logical Design options (Cloud Management Platform, Compute, Network, Storage, Virtual Machine, Security, Backup/Recovery, BC/DR, Virtual Infrastructure Management) and Physical Design options.
...
* Functioning Supporting Documents Library (Implementation Plan, Configuration Guide, Test Plan, Standard Operating Procedures, Blueprints).
