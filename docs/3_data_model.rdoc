...
* To be defined (Links to public URLs and custom procedures if necessary)
== Test Plans
* To be defined (Functional, Integration, Recovery and Performance)
...
== Bill of Materials
* Need to decide how to automatically roll up the hardware, software and licencing quantities.
...
* To be defined
== Project Blueprints
* To be defined - probably references to uploaded JPEGs prepared by the project architect
