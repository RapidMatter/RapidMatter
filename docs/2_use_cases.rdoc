This is the Day-1 prototype use case:
= Use Design Wizard for Solution Design and Export for Implementation
* User Registration and Login
* Create a Project Repository
* Start the Design Wizard
* Enter Project Name and Description
* Select Beginner/Advanced/Expert level of design
* Select Technology Area (Data Center Virtualisation, Cloud, End User Computing, Service Provider Network, Enterprise Network)
* Select Hosting Model (Private Cloud, Public Cloud, Hybrid Cloud)
